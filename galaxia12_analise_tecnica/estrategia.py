...
class BigStrategy():
    ...
    def add_cdi(self):
        ...
        self.dados_cdi = pd.read_parquet(os.path.join(".", "dados", 'cdi.parquet'))
    ...
    def make_report(self, nome_arquivo = 'backtest.pdf'):
        ...
        MakeReportResult(df_trades=self.df_trades, df_dados = self.dados_filtrados_data, nome_arquivo=nome_arquivo) 

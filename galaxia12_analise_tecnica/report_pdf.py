...
class MakePDF():
    ...
    def __init__(self, drawdown_maximo, dia_inicial, dia_final, dias_totais_backtest, 
                 ...
                 otimizacao = False, nome_arquivo = "backtest.pdf"):
    ...
    def grafico_preco_indicadores(self):
        ...
        self.pdf.image(os.path.join(".", "imagens", "grafico_sinais.png"), w = 175, h = 80, x = 20, y = 50)
    ...
    def eventos_estresse(self):
        ...
        self.pdf.image(os.path.join(".", "imagens", 'nave2.png'), x = 130, y = 140, w = 50, h = 50)

    
    def grafico_underwater(self):


        self.pdf.image(os.path.join(".", "imagens", "grafico_underwater.png"), w = 140, h = 60, x = 35, y = 200)
    ...
    def grafico_parametros(self):
        ...
        for i in range(0, (len(self.df_otimizacao))):
            ...
            if i % 2 == 0:
                ...
                self.pdf.image(os.path.join(".", "imagens", f"retorno_por_parametro_{i}.png"), w = 175, h = 80, x = 20, y = 50)

            else:
                
                self.pdf.image(os.path.join(".", "imagens", f"retorno_por_parametro_{i}.png"), w = 175, h = 80, x = 20, y = 150)

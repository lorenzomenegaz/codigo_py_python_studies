...
class PDF(FPDF):
    ...
    def header(self):
        ...
        self.image(os.path.join('.', 'imagens', 'logo.png'), 10, 8, 40)
...
class MakePDF():
    ...
    def __init__(self, dd_all, dia_inicial, dia_final, dias_totais_backtest, 
        ...
        shutil.move(f'./{self.nome_arquivo}', f'./pdfs/{self.nome_arquivo}')
    ...
    def grafico_retorno_acum(self):
        ...
        self.pdf.image(os.path.join('.', 'imagens', 'rent_acum.png'), w = 140, h = 80, x = 55, y = 44.9)
    ...
    def tabelas_estatisticas_gerais(self):
        ...
        self.pdf.image(os.path.join('.', 'imagens', 'nave1.png'), x = 70, y = 225, w = 75, h = 33)
    ...
    def eventos_estresse_e_dias_sem_lucro(self):
        ...
        self.pdf.image(os.path.join('.', 'imagens', 'nave2.png'), x = 90, y = 105, w = 50, h = 50)

    
    def grafico_underwater(self):


        self.pdf.image(os.path.join('.', 'imagens', 'grafico_underwater.png'), w = 140, h = 90, x = 35, y = 160)

    def retorno_ano_a_ano_mes_a_mes(self):

        self.pdf.add_page()

        self.pdf.image(os.path.join('.', 'imagens', "grafico_ano.png"), w = 175, h = 80, x = 20, y = 50)
        self.pdf.image(os.path.join('.', 'imagens', "grafico_mes.png"), w = 175, h = 80, x = 20, y = 150)

    def grafico_janelas_moveis(self):

        self.pdf.add_page()

        self.pdf.image(os.path.join('.', 'imagens', "janela_movel_12M_retorno_movel.png"), w = 80, h = 64, x = 15, y = 45)
        self.pdf.image(os.path.join('.', 'imagens', "janela_movel_12M_alfa.png"), w = 80, h = 64, x = 110, y = 45)
        self.pdf.image(os.path.join('.', 'imagens', "janela_movel_24M_retorno_movel.png"), w = 80, h = 64, x = 15, y = 115)
        self.pdf.image(os.path.join('.', 'imagens', "janela_movel_24M_alfa.png"), w = 80, h = 64, x = 110, y = 115)
        self.pdf.image(os.path.join('.', 'imagens', "janela_movel_36M_retorno_movel.png"), w = 80, h = 64, x = 15, y = 185)
        self.pdf.image(os.path.join('.', 'imagens', "janela_movel_36M_alfa.png"), w = 80, h = 64, x = 110, y = 185)

...
class premio_risco:
    ...
    def pegando_dados_cotacoes(self):
        ...
        self.cotacoes = pd.read_parquet(os.path.join('.', 'dados', 'cotacoes.parquet'))
    ...
    def filtrando_volume(self):
        ...
        dados_volume = pd.read_parquet(os.path.join('.', 'dados', 'volume_mediano.parquet'))
    ...
    def pegando_indicadores(self):
        ...
        for indicador in self.indicadores:
            try:
                df = pd.read_parquet(os.path.join('.', 'dados', f'{indicador}.parquet'))
...
if __name__ == "__main__":
    ...
    indicadores_dict = {'ValorDeMercado': 'crescente',
                        }

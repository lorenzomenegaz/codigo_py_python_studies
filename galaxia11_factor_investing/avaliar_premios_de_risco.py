...
class MakeResultsPremium:
    ...
    def __init__(self, dicionario_fatores, data_final_analise, nome_arquivo = 'premios_de_risco.pdf' ):
    ...
    def puxando_dados(self):
        ...
        for i, nome_premio in enumerate(self.lista_nome_fatores):
            ...
            df = pd.read_parquet(os.path.join(".", "dados", "premios_de_risco", f'{nome_premio}_{self.liquidez[i]}.parquet'))
    ...
    def retorno_quartis(self):
        ...
        for i, nome_premio in enumerate(self.lista_nome_fatores):
            ...
            plt.savefig(os.path.join(".", "imagens", f'barras_quartis_{nome_premio}_{self.liquidez[i]}'))
            ...
            plt.savefig(os.path.join(".", "imagens", f'linha_quartis_{nome_premio}_{self.liquidez[i]}'))
            ...
            plt.savefig(os.path.join(".", "imagens", f'premio_de_risco_{nome_premio}_{self.liquidez[i]}'))
            ...
            plt.savefig(os.path.join(".", "imagens", f'movel_12m_premio_de_risco_{nome_premio}_{self.liquidez[i]}'))
        ...
        plt.savefig(os.path.join(".", "imagens", f'comparando_1Q'))
        ...
        plt.savefig(os.path.join(".", "imagens", f'comparando_premios'))
...
if __name__ == "__main__":
    ...
    premios = MakeResultsPremium(data_final_analise="2020-12-31", dicionario_fatores=dicionario_fatores,     
                                 nome_arquivo = 'avaliando_todos_premios.pdf',
                                 )

...
class MakePDF():
    ...
    def primeira_pagina(self):
        ...
        self.pdf.image(os.path.join(".", "imagens", "comparando_1Q.png"), w = 180, h = 90, x = 13, y = 60)
        self.pdf.image(os.path.join(".", "imagens", "comparando_premios.png"), w = 180, h = 90, x = 13, y = 160)
    ...
    def pagina_fator(self, nome_fator, liquidez):
        ...
        self.pdf.add_page()
        self.pdf.image(os.path.join(".", "imagens", f"barras_quartis_{nome_fator}_{liquidez}.png"), w = 95, h = 80, x = 10, y = 60)
        self.pdf.image(os.path.join(".", "imagens", f"linha_quartis_{nome_fator}_{liquidez}.png"), w = 95, h = 80, x = 110, y = 60)
        self.pdf.image(os.path.join(".", "imagens", f"movel_12m_premio_de_risco_{nome_fator}_{liquidez}.png"), w = 95, h = 80, x = 10, y = 160)
        self.pdf.image(os.path.join(".", "imagens", f"premio_de_risco_{nome_fator}_{liquidez}.png"), w = 95, h = 80, x = 110, y = 160)